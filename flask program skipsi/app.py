...
@app.route('/editSaham', methods=['GET', 'POST'])
def editSaham():
    ...
    return render_template('editSaham.html', stocks=stocks)
...
def riwayat():
    ...
    return render_template('riwayat.html', lulus=lulus, total=len(lulus))
